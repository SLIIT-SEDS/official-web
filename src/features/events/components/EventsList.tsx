...
const EventsList = () => {
  ...
  const years = Array.from(new Set(eventsData.map((e) => e.year)));
                ...
                return (
                  <div key={year} className="space-y-6 sm:space-y-8">
                    ...
                    <div className="flex items-center gap-4">
                      <h2
                        className="text-3xl sm:text-4xl md:text-5xl font-light tracking-widest text-white/90 uppercase select-none"
                        style={{ fontFamily: "'Exo 2', 'Rajdhani', sans-serif" }}
                      >
                        {year}
                      </h2>
                      <div className="h-px flex-1 bg-gradient-to-r from-white/20 via-purple-500/20 to-transparent" />
                    </div>
