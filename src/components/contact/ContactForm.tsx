    ...
    return (
        ...
        >
            ...
            >
                ...
                <label htmlFor="name" className="m-3">Your Name</label>
                <input
                    type="text"
                    id="name"
                ...
                <label htmlFor="email" id="email" className="m-3">Your Email Adress</label>
                <input
                    type="email"
                    id="email"
                    className="w-2/3 outline-none border border-purple-600 rounded px-2 py-0.5 bg-transparent"
                ...
                <label htmlFor="textarea" className="m-3">Your Message</label>
                <textarea
                    id="textarea"
