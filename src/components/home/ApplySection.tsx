...
const ApplySection = () => {
    ...
    return (
        <section className="relative z-20 min-h-screen flex flex-col items-center justify-center px-6 md:px-12 lg:px-20 bg-transparent snap-start">
            {/* Purple ambient glow */}
            ...
            {/* Card container */}
            <div className="w-full max-w-xl bg-[#0f0b14]/40 border border-white/10 rounded-2xl backdrop-blur-md p-8 md:p-12">
                <h2 className="text-3xl sm:text-4xl font-light tracking-wider text-white mb-10 select-none text-center">
                    Apply Now!
                </h2>
