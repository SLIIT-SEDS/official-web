...
const EventsPage = () => {
  ...
  return (
    <div className="min-h-screen pt-24 pb-20 relative flex flex-col items-center justify-start bg-[#090709]">
      ...
      <div className="absolute top-0 left-0 w-full h-screen bg-gradient-to-r from-black/60 via-[#090709]/25 to-transparent z-0 pointer-events-none" />
      <div className="absolute top-0 left-0 w-full h-screen bg-gradient-to-b from-transparent via-[#090709]/30 to-[#090709] z-0 pointer-events-none" />
